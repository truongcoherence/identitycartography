# Structuria — Canon (v1.0) (ARCHIVAL)

Structuria describes the physics that acts on identity. These includes states identity can behave under like the Identity Domain Physics 
...
4. [Stewardship](STEWARDSHIP.md)
5. [Peril](PERIL.md)

#### Architectrual Physics / Metaphysics
- [Geophysics](GEOPHYSICS.md)
- [Quantum](QUANTUM.md)
- [Chronophysics](CHRONOPHYSICS.md)
- [Topophysics](TOPOPHYSICS.md)
- [Morphophysics](MORPHOPHYSICS.md)
