...
_Which physics are active here? What force is shaping my behavior? What is this moment actually made of?_
...
Chronophysics describes the **time‑scale physics** of identity — the forces that shape how possibility evolves, accelerates, decays, or collapses across duration. While Geophysics explains large‑scale movement and Quantum explains micro‑instability, Chronophysics explains **how identity behaves across time**.
